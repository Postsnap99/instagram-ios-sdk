#
#  Be sure to run `pod spec lint instagram-ios-sdk.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/crino/instagram-ios-sdk"
  ...
  s.source       = { :git => "https://github.com/adamkuipers/instagram-ios-sdk.git", :tag => "1.1.2" }
